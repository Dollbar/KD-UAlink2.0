...
Optional --candidate FILE and --label NAME. Produces actual mapped netlists,
...
def main():
    ...
    sources = [ROOT / "rtl/tl" / n for n in ("tl_credit_admission.v", "tl_control_decode.v", "tl_control_tenure.v")]
