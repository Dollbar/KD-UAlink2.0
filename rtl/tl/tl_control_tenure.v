module tl_control_tenure(input wire [255:0] i_half,output reg [1:0] o_status,output reg [3:0] o_fields,output reg [31:0] o_data_counts,output reg [7:0] o_byte_enable); // 并行字段派生逻辑
wire [255:0] unused_payload=i_half; // 保留未消费字段位
...
wire four3=(i_half[127:124]==4'd1); // 自然对齐四sector字段
wire four7=(i_half[255:252]==4'd1); // 自然对齐四sector字段
wire two1=(i_half[63:60]==4'd2)||(i_half[63:60]==4'd3); // 自然对齐双sector字段
wire two3=(i_half[127:124]==4'd2)||(i_half[127:124]==4'd3); // 自然对齐双sector字段
wire two5=(i_half[191:188]==4'd2)||(i_half[191:188]==4'd3); // 自然对齐双sector字段
wire two7=(i_half[255:252]==4'd2)||(i_half[255:252]==4'd3); // 自然对齐双sector字段
wire use3=1'b1; // 并行字段派生逻辑
wire use2=!four3&&!two3; // 并行字段派生逻辑
wire use1=!four3; // 并行字段派生逻辑
wire use0=!four3&&!two1; // 并行字段派生逻辑
wire use7=1'b1; // 并行字段派生逻辑
wire use6=!four7&&!two7; // 并行字段派生逻辑
wire use5=!four7; // 并行字段派生逻辑
wire use4=!four7&&!two5; // 并行字段派生逻辑
always @* begin // 并行字段派生逻辑
...
if(o_status==2'd0) begin // 错误时全部描述符清零
