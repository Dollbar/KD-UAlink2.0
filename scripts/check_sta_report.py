...
def check_report(text, design="credit"):
    if design not in ("credit", "initialization", "return", "receive", "burst_control"):
...
def main():
    ...
    parser.add_argument("--design", choices=("credit", "initialization", "return", "receive", "burst_control"), default="credit")
